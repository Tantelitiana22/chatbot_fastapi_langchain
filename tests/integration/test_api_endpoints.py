...
class TestRunner:
    """Test runner for API endpoint testing."""
    ...
    def test_basic_chat(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                self.log(
                    f"❌ Chat test failed with status {response.status_code}", "ERROR"
                )
                return False
    ...
    def test_memory_functionality(self):
        ...
        # First message
        conversation = {"id": "test-memory", "messages": []}
        ...
        try:
            ...
            if (
                "python" in full_response2.lower()
                or "project" in full_response2.lower()
            ):
                self.log("✅ Memory functionality test passed")
                return True
            else:
                self.log(
                    "⚠️ Memory test inconclusive - no clear reference to previous context",
                    "WARNING",
                )
